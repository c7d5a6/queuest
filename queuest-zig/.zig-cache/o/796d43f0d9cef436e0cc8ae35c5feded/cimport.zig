...
pub const struct_re_dfa_t_2 = opaque {};
// (no file):33:1: warning: struct demoted to opaque type - has bitfield
...
pub const regmatch_t = extern struct {
    rm_so: regoff_t = @import("std").mem.zeroes(regoff_t),
    rm_eo: regoff_t = @import("std").mem.zeroes(regoff_t),
};
...
pub extern fn alloc_regex_t() ?*regex_t;
pub extern fn free_regex_t(ptr: ?*regex_t) void;
...
pub const __REPB_PREFIX = @compileError("unable to translate macro: undefined identifier `__`");
// /usr/include/regex.h:410:10
...
pub const _Restrict_ = @compileError("unable to translate C expr: unexpected token '__restrict'");
// /usr/include/regex.h:649:11
