...
export class ItemsService extends BaseService {
     ...
     */
    itemsControllerGetItems$Response(
        params?: {},
        context?: HttpContext,
    ): Observable<StrictHttpResponse<Array<ItemEntity>>> {
        const rb = new RequestBuilder(
            this.rootUrl,
            ItemsService.ItemsControllerGetItemsPath,
            'get',
        );
        if (params) {
        }
    ...
    itemsControllerGetItems(
        ...
        return this.itemsControllerGetItems$Response(params, context).pipe(
            map(
                (r: StrictHttpResponse<Array<ItemEntity>>) =>
                    r.body as Array<ItemEntity>,
            ),
        );
    }
     ...
     */
    itemsControllerAddItem$Response(
        params: {
            body: Item;
        },
        context?: HttpContext,
        ...
        const rb = new RequestBuilder(
            this.rootUrl,
            ItemsService.ItemsControllerAddItemPath,
            'post',
        );
        if (params) {
     ...
     * This method doesn't expect any request body.
     */
    itemsControllerGetBestPairs$Response(
        params: {
            size: number;
        },
        context?: HttpContext,
        ...
        const rb = new RequestBuilder(
            this.rootUrl,
            ItemsService.ItemsControllerGetBestPairsPath,
            'get',
        );
        if (params) {
    ...
    itemsControllerGetBestPairs(
        ...
        return this.itemsControllerGetBestPairs$Response(params, context).pipe(
            map(
                (r: StrictHttpResponse<Array<ItemPair>>) =>
                    r.body as Array<ItemPair>,
            ),
        );
    }
     ...
     * This method doesn't expect any request body.
     */
    itemsControllerGetLastItem$Response(
        params?: {},
        context?: HttpContext,
    ): Observable<StrictHttpResponse<ItemEntity>> {
        const rb = new RequestBuilder(
            this.rootUrl,
            ItemsService.ItemsControllerGetLastItemPath,
            'get',
        );
        if (params) {
        }
     ...
     * This method doesn't expect any request body.
     */
    itemsControllerGetBestPair$Response(
        params: {
            id: number;
        ...
        const rb = new RequestBuilder(
            this.rootUrl,
            ItemsService.ItemsControllerGetBestPairPath,
            'get',
        );
        if (params) {
     ...
     * This method sends `application/json` and handles request body of type `application/json`.
     */
    itemsControllerAddRelation$Response(
        params: {
            body: ItemRelation;
        },
        context?: HttpContext,
        ...
        const rb = new RequestBuilder(
            this.rootUrl,
            ItemsService.ItemsControllerAddRelationPath,
            'post',
        );
        if (params) {
            rb.body(params.body, 'application/json');
     ...
     * This method sends `application/json` and handles request body of type `application/json`.
     */
    itemsControllerDeleteRelation$Response(
        params: {
            body: ItemRelation;
        },
        context?: HttpContext,
        ...
        const rb = new RequestBuilder(
            this.rootUrl,
            ItemsService.ItemsControllerDeleteRelationPath,
            'delete',
        );
        if (params) {
            rb.body(params.body, 'application/json');
    ...
    itemsControllerDeleteRelation(
        ...
        return this.itemsControllerDeleteRelation$Response(
            params,
            context,
