...
export class CollectionsService extends BaseService {
     ...
     */
    static readonly CollectionControllerGetCurrentUserCollectionsPath =
        '/collections';
     ...
     */
    collectionControllerGetCurrentUserCollections$Response(
        params?: {},
        context?: HttpContext,
    ): Observable<StrictHttpResponse<Array<Collection>>> {
        const rb = new RequestBuilder(
            this.rootUrl,
            CollectionsService.CollectionControllerGetCurrentUserCollectionsPath,
            'get',
        );
        if (params) {
        }
    ...
    collectionControllerGetCurrentUserCollections(
        ...
        return this.collectionControllerGetCurrentUserCollections$Response(
            params,
            context,
        ).pipe(
            map(
                (r: StrictHttpResponse<Array<Collection>>) =>
                    r.body as Array<Collection>,
            ),
        );
    }
     ...
     */
    collectionControllerAddCollection$Response(
        params: {
            body: Collection;
        },
        context?: HttpContext,
        ...
        const rb = new RequestBuilder(
            this.rootUrl,
            CollectionsService.CollectionControllerAddCollectionPath,
            'post',
        );
        if (params) {
     ...
     * This method sends `application/json` and handles request body of type `application/json`.
     */
    collectionControllerAddCollection(
        params: {
            body: Collection;
        },
        context?: HttpContext,
    ): Observable<void> {
        return this.collectionControllerAddCollection$Response(
            params,
            context,
     ...
     */
    static readonly CollectionControllerGetCollectionPath =
     ...
     * This method doesn't expect any request body.
     */
    collectionControllerGetCollection$Response(
        params: {
            collectionId: number;
        },
        context?: HttpContext,
        ...
        const rb = new RequestBuilder(
            this.rootUrl,
            CollectionsService.CollectionControllerGetCollectionPath,
            'get',
        );
        if (params) {
    ...
    collectionControllerGetCollection(
        ...
        return this.collectionControllerGetCollection$Response(
            params,
            context,
        ).pipe(
     ...
     */
    static readonly CollectionControllerGetCurrentUserFavoriteCollectionsPath =
        '/collections/fav';
     ...
     * This method doesn't expect any request body.
     */
    collectionControllerGetCurrentUserFavoriteCollections$Response(
        params?: {},
        context?: HttpContext,
    ): Observable<StrictHttpResponse<Array<Collection>>> {
        const rb = new RequestBuilder(
            this.rootUrl,
            CollectionsService.CollectionControllerGetCurrentUserFavoriteCollectionsPath,
            'get',
        );
        if (params) {
        }
    ...
    collectionControllerGetCurrentUserFavoriteCollections(
        ...
        return this.collectionControllerGetCurrentUserFavoriteCollections$Response(
            params,
            context,
        ).pipe(
            map(
